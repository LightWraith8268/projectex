...
import dev.latvian.mods.projectex.network.RecipeTransferPacket;
...
public class AlchemyTableRecipeTransferHandler implements IRecipeTransferHandler<AlchemyTableMenu, RecipeHolder<CraftingRecipe>> {
	...
	public @Nullable IRecipeTransferError transferRecipe(
		...
		PacketDistributor.sendToServer(new RecipeTransferPacket(
				recipeHolder.id(),
				maxTransfer
		));

		return null; // Transfer initiated successfully
	}
}
